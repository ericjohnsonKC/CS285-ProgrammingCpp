...
{
    T tempNumerator = numerator * otherFraction.getDenominator();
    T tempOtherFracNumerator = otherFraction.getDenominator() * denominator;

    return (tempNumerator == tempOtherFracNumerator);
}
